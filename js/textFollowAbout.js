...
const text = document.getElementById('cursorTextAbout');
...
// Select the image in the taylorImageContainer
const aboutImage = document.querySelectorAll('#taylorImageContainer img');
